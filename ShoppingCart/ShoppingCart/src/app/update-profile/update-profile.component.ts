...
export class UpdateProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.profileDetails.emailId = this.storageService.getUser().email;
  ...
  editprofile() {
    this.profileService.updateProfile(this.profileDetails,this.profileDetails.fullName).subscribe((data) => {
      console.log(data);
      alert('saved');
    });
